...
#define FEATURE_WATER_LED       0                       // Turn on water LED when in water mode, 0 = deactivated, 1 = activated, 2 = activated inverted
#define FEATURE_STEAM_LED       0                       // Turn on steam LED when in steam mode, 0 = deactivated, 1 = activated, 2 = activated inverted
...
#define FEATURE_PRESSURESENSOR 0                        // 0 = deactivated, 1 = activated honeywell i2c, 2 = activated analog ads over i2c
...
#define TEMP_SENSOR 2  // Temp sensor type: 1 = DS18B20, 2 = TSIC306, 3 = MAX6675
