...
public:
    ...
    PumpDimmerCore(GPIOPin& outputPin, GPIOPin& zeroCrossPin, int timerNum);
...
private:
    ...
    enum class TimerPhase { DELAY, RESET };  // Nested inside the class
    ...
    static PumpDimmerCore* instance;
